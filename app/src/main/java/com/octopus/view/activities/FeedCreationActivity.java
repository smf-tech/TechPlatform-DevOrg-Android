...
import com.octopus.models.Matrimony.MeetBatchesResponseModel;
import com.octopus.models.login.LoginInfo;
import com.octopus.view.adapters.ShowBatchesPageRecyclerAdapter;
import com.octopus.view.fragments.FeedCreateFragment;

public class FeedCreationActivity extends BaseActivity implements View.OnClickListener, ShowBatchesPageRecyclerAdapter.OnRequestItemClicked {
    private final String TAG = FeedCreationActivity.class.getName();
...
//            OtpFragment otpFragment = new OtpFragment();
    ...
    public void onItemClicked(int pos) {
        ...
        Log.e(TAG, "Exception :: OtpActivity : initView");
        fragment = new FeedCreateFragment();
...
//fragment class name : DFragment
    ...
    private void launchFragment(){
        ...
        fragment = new FeedCreateFragment();
        bundle.putString("filter_type", "User Approval");
        bundle.putString("bachesObjectString","");
        fragment.setArguments(bundle);
        openFragment();
        toolbar_title.setText("Create Feed");
    }
