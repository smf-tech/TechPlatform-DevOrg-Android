...
import com.octopus.listeners.FormTaskListener;
...
import com.octopus.presenter.FormStatusFragmentPresenter;
...
import com.octopus.view.adapters.SubmittedFormsListAdapter;
...
import static com.octopus.presenter.PMFragmentPresenter.getAllNonSyncedSavedForms;
import static com.octopus.syncAdapter.SyncAdapterUtils.EVENT_FORM_SUBMITTED;
import static com.octopus.syncAdapter.SyncAdapterUtils.EVENT_SYNC_COMPLETED;
import static com.octopus.syncAdapter.SyncAdapterUtils.EVENT_SYNC_FAILED;
import static com.octopus.syncAdapter.SyncAdapterUtils.PARTIAL_FORM_REMOVED;
import static com.octopus.utility.Constants.FORM_DATE_FORMAT;
...
public class SubmittedFormsFragment extends Fragment implements FormStatusCallListener, FormTaskListener, View.OnClickListener {
    ...
    private void setPendingForms() {
        ...
        List<com.octopus.models.forms.FormResult> savedForms = getAllNonSyncedSavedForms(getContext());
        if (savedForms != null && !savedForms.isEmpty()) {

            showNoDataText = false;
            for (com.octopus.models.forms.FormResult formResult : savedForms) {
