...
public class TMFiltersListRequestCall {

    private TMFilterListRequestCallListener listener;
    private final String TAG = TMFiltersListRequestCall.class.getName();
    ...
    public void getAllPendingRequests() {
        ...
        final String getPendingRequestsUrl = BuildConfig.BASE_URL + Urls.TM.GET_TM_FILTERS_REQUESTS;
