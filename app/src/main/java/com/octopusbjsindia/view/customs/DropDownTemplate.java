...
import com.octopusbjsindia.view.adapters.FormSpinnerAdapter;
import com.octopusbjsindia.view.fragments.FormFragment;
import com.octopusbjsindia.widgets.PlatformSpinner;
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if (i != -1) {
            if (selectedChoice != null && !selectedChoice.getValue().equals(context.get().getString(R.string.default_select))) {
                ...
                if (tv != null) {
                    tv.setTextColor(ContextCompat.getColor(Platform.getInstance(), R.color.dark_grey));
                }
