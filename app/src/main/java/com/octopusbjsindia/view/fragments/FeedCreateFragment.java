...
public class FeedCreateFragment extends Fragment implements View.OnClickListener {
    private final String TAG = FeedCreateFragment.class.getName();
    private View fragmentview;
    private String uploadImageType = "";
    private Button btn_load_next;
    private ImageView img_adhar;
    private EditText et_about_me, et_achivements, et_partner_expectation;
    //image upload
    private Uri outputUri;
    private Uri finalUri;

    public static FeedCreateFragment newInstance() {
        return new FeedCreateFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        fragmentview = inflater.inflate(R.layout.feed_create_fragment, container, false);
        initViews();
        return fragmentview;
    }
            ...
            try {
                ...
                if (Util.isConnected(getActivity())) {
                    if (Util.isValidImageSize(imageFile)) {
                        ...
                        if (Constants.Image.IMAGE_TYPE_ADHARCARD.equalsIgnoreCase(uploadImageType)) {
