...
public class WorkshopPreFeedbackFragment extends Fragment implements View.OnClickListener , CustomSpinnerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_pre_workshop_feedback, container, false);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bt_next:
                if (isAllInputsValid()) {
                    ((SmartGirlWorkshopListActivity) getActivity()).submitFeedbsckToWorkshop(0, 2, new Gson().toJson(getFeedbackReqJson(0)));
                }
                break;
    ...
    private boolean isAllInputsValid() {
        ...
        }else if (et_select_mobile.getText().toString().trim().length() < 10) {
