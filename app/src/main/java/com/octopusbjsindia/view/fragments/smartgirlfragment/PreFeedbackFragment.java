...
public class PreFeedbackFragment extends Fragment implements View.OnClickListener , CustomSpinnerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_pre_feedback, container, false);
    ...
    public JsonObject getFeedbackReqJson(int pos) {
        ...
        requestObject.addProperty("feedback_type", "Pre");
