...
public class VDCCMFormFragment extends Fragment implements View.OnClickListener, APIDataListener, CustomSpinnerListener {
    private static final String TAG = VDCCMFormFragment.class.getCanonicalName();
    private ProgressBar progressBar;
    private RelativeLayout progressBarLayout;
    private String selectedImageType ="";
    public static final String IMAGE_ACTIVITY = "imageofactivity";
    public static final String IMAGE_MEETING = "imageofmeeting";
    public static final String IMAGE_ATTENDANCE = "imageofattendance";
    ...
    private void init() {
        ...
        presenter = new VDCCMFormFragmentPresenter(this);
        etState = vdccmFormFragmentView.findViewById(R.id.et_state);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.iv_activity_photo:
                if (Util.isConnected(getActivity())) {
                    onAddImageClick();
                    selectedImageType = IMAGE_ACTIVITY;
                } else {
                    Util.showToast(getActivity(),getResources().getString(R.string.msg_no_network));
                }
                break;
            case R.id.iv_meeting_photo:
                if (Util.isConnected(getActivity())) {
                    onAddImageClick();
                    selectedImageType = IMAGE_MEETING;
                } else {
                    Util.showToast(getActivity(),getResources().getString(R.string.msg_no_network));
                }
                break;
            case R.id.iv_attendace_sheet_photo:
                if (Util.isConnected(getActivity())) {
                    onAddImageClick();
                    selectedImageType = IMAGE_ATTENDANCE;
                } else {
                    Util.showToast(getActivity(),getResources().getString(R.string.msg_no_network));
                }
                break;
