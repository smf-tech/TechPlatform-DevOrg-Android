...
public class AllTrainersListRecyclerAdapter extends RecyclerView.Adapter<AllTrainersListRecyclerAdapter.EmployeeViewHolder> {

    Context mContext;
    private List<SGTrainersList>  dataList;
    private OnRequestItemClicked clickListener;


    public AllTrainersListRecyclerAdapter(Context context, List<SGTrainersList>  dataList, final OnRequestItemClicked clickListener) {
        mContext = context;
    ...
    public EmployeeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.row_alltrainer_list, parent, false);
