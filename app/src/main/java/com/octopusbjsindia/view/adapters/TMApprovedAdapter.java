...
import com.octopusbjsindia.presenter.ApprovedFragmentPresenter;
...
public class TMApprovedAdapter extends BaseExpandableListAdapter {
    ...
    public TMApprovedAdapter(final Context context, final Map<String,
            List<PendingRequest>> approvedRequestMap, ApprovedFragmentPresenter presenter) {
            ...
            if (data != null && data.getEntity() != null && data.getEntity().getUser() != null) {
                ...
                ((TextView) view.findViewById(R.id.txt_pending_request_created_at))
                        .setText(String.format("%s",
                                Util.getDateTimeFromTimestamp(data.getUpdatedDateTime())));
            }
