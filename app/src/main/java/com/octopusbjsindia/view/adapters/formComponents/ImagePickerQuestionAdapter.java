...
public class ImagePickerQuestionAdapter extends RecyclerView.Adapter<ImagePickerQuestionAdapter.EmployeeViewHolder> implements MatrixQuestionColoumnAdapter.OnRequestItemClicked {
    ...
    private ImagePickerQuestionFragment fragment;

    public ImagePickerQuestionAdapter(ImagePickerQuestionFragment fragment, Context context, Elements elements, final OnRequestItemClicked clickListener) {
        mContext = context;
