...
public class Urls {
    ...
    public class Profile {
        ...
        public static final String GET_BENEFICIARY_INFO = "api/getBeneficiaryInfo";
    ...
    public class SSModule {
        ...
        public static final String SILT_TRANSPORT_BENEFICIARY_FORM = "api/insertSiltTransportationData";
    ...
    public class OperatorApi {
        public static final String MACHINE_WORKLOG = "api/rwbMachineWorkLog";
        public static final String MACHINE_DATA = "api/getMachineData/%1$s";
        public static final String MACHINE_DATA_V2 = "api/getMachineDataV2/%1$s";
