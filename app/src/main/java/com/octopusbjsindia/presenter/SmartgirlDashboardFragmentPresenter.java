...
import com.octopusbjsindia.view.fragments.SmartGirlDashboardFragment;
...
public class SmartgirlDashboardFragmentPresenter implements APIPresenterListener {

    private WeakReference<SmartGirlDashboardFragment> fragmentWeakReference;
    private final String TAG = SmartgirlDashboardFragmentPresenter.class.getName();
    ...
    public static final String GET_DASHBOARD_DATA = "getSGMasterData";
    ...
    public SmartgirlDashboardFragmentPresenter(SmartGirlDashboardFragment tmFragment) {
    ...
    public void getSGMasterData(){
        fragmentWeakReference.get().showProgressBar();
        APIRequestCall requestCall = new APIRequestCall();
        requestCall.setApiPresenterListener(this);
        String getSGMasterDaraUrl = BuildConfig.BASE_URL
                    + String.format(Urls.SmartGirl.GET_MASTER_TRAINER_DASHBOARD);
        Log.d(TAG, "getSGMasterDaraUrl: url" + getSGMasterDaraUrl);
        requestCall.getDataApiCall(GET_DASHBOARD_DATA, getSGMasterDaraUrl);
    }
    ...
    public void onSuccessListener(String requestID, String response) {
        ...
        try {
            if (response != null) {
                        if(requestID.equals(SmartgirlDashboardFragmentPresenter.GET_DASHBOARD_DATA)){
                            fragmentWeakReference.get().populateDashboardData(requestID, response);
                        }

                /*if (requestID.equals(SmartgirlDashboardFragmentPresenter.GET_STRUCTURE_ANALYTICS) ||
                        requestID.equals(SmartgirlDashboardFragmentPresenter.GET_MACHINE_ANALYTICS)) {
                ...
                } else if (requestID.equals(SmartgirlDashboardFragmentPresenter.GET_DASHBOARD_DATA)) {
