...
public class RegisterTrainerFragmentPresenter  implements APIPresenterListener {

    private static final String GET_MV_USER_INFO = "getMvUserInfo";

    RegisterTrainerFragment mContax;

    public RegisterTrainerFragmentPresenter(RegisterTrainerFragment fragment) {
