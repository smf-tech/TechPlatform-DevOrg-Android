...
//    }
    ...
    public void assignHospitaltoIncharge(HashMap request) {
        ...
        Gson gson = new GsonBuilder().create();
        String params = gson.toJson(request);
        final String insertMachineUrl = BuildConfig.BASE_URL + Urls.MissionRahat.ADD_INCHARGE_REQUEST;
        APIRequestCall requestCall = new APIRequestCall();
        requestCall.setApiPresenterListener(this);
        requestCall.postDataApiCall("HOSPITAL_ASSIGNMENT_REQUEST", params, insertMachineUrl);
    }
