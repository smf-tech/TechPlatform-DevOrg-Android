...
public class SujalamSuphalamGPPresenter implements APIPresenterListener {

    private WeakReference<SujalamSufalamGPFragment> fragmentWeakReference;
    private final String TAG = SujalamSuphalamGPPresenter.class.getName();
    ...
    public SujalamSuphalamGPPresenter(SujalamSufalamGPFragment tmFragment) {
    ...
    public void onSuccessListener(String requestID, String response) {
        ...
        try {
            if (response != null) {
                if (requestID.equals(SujalamSuphalamGPPresenter.GET_STRUCTURE_ANALYTICS) ||
                        requestID.equals(SujalamSuphalamGPPresenter.GET_MACHINE_ANALYTICS)) {
