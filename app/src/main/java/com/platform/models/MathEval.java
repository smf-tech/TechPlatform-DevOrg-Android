...
//    }
     ...
     * Pure functions have results which depend purely on their arguments; given constant arguments they will have a constant result.  Impure functions are rare.
     */
    private MathEval setFunctionHandler(String nam, FunctionHandler hdl, boolean impure) {
        validateName(nam);
        if (hdl == null) {
...
//    }
     ...
     */
    private MathEval setVariable(String nam, Double val) {
        validateName(nam);
        if (val == null) {
...
// *************************************************************************************************
     ...
     */
    static private final int LEFT_SIDE = 'L';
    /**
     * Operator/operand on on the right.
     */
    static private final int RIGHT_SIDE = 'R';
    /**
