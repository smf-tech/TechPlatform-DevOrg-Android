...
public class MachineDetailsFragmentPresenter implements APIPresenterListener {

    private WeakReference<MachineDetailsFragment> fragmentWeakReference;
    ...
    public MachineDetailsFragmentPresenter(MachineDetailsFragment tmFragment) {
